...
def get_arch(opt):
    ...
    elif arch == 'ShuffleFormer_B':
        model_restoration = ShuffleFormer(img_size=opt.train_ps, embed_dim=32, win_size=8, token_projection='linear', token_mlp='leff',
            depths=[1, 2, 8, 8, 2, 8, 8, 2, 1], dd_in=opt.dd_in, repeat=opt.repeat_num)
    else:
